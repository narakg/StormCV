 ...
 * topology as {@link Frame} objects. The ImageFetcher works in the same way as
 * the {@link FileFrameFetcher}; it expands locations it gets looking for image
...
public class ImageFetcher implements IFetcher<Frame> {
    ...
    private final FrameSerializer serializer = new FrameSerializer();
