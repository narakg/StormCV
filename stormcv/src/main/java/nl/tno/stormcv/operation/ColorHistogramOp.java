...
public class ColorHistogramOp extends OpenCVOp<Feature> implements ISingleInputOperation<Feature> {
     ...
     * @param histsize for each channel the number of bins to use, default =
     * {255, 255 ,255}
     * @param ranges for each channel the min. and max. values present, default
     * = {0, 256, 0, 256, 0, 256 }
     * @return
     * @see
     * <a href="http://docs.opencv.org/2.4.8/modules/imgproc/doc/histograms.html">OpenCV
     * Documentation</a>
     */
    ...
    public List<Feature> execute(CVParticle input) throws Exception {
        ...
        ArrayList<Descriptor> hist_descriptors = new ArrayList<>();
