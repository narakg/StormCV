...
/**
 * Utility class used to maintain a set of {@link FileConnector} implementations
 * registered in the {@link StormCVConfig}. An instantiated ConnectorHolder can
 * be fetched from the Storm configuration after which it can be used to request
 * connectors for urls. getConnector("s3://bucket/path/bideo.mp4") will return
 * the configured {@link S3Connector} object.
 *
...
public class ConnectorHolder {
    ...
    /**
     * Uses the provided stormConf to instantiate and configure registered
     * {@link FileConnector}'s using {@link StormCVConfig}.STORMCV_CONNECTORS
     *
     * @param stormConf
     */
